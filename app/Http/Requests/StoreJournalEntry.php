...
class StoreJournalEntry extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'date' => ['required', 'date'],
            'document_type_id' => ['required', 'exists:App\Models\Document,id'],
            ...
            "postings.'subsidiary_ledger_id'.*" => ['sometimes', 'exists:App\Models\SubsidiaryLedger,id', 'nullable'],
            "postings.'report_line_item_id'.*" => ['sometimes', 'exists:App\Models\ReportLineItem,id', 'nullable'],
        ];
    }
