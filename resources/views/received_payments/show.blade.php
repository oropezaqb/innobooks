...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header font-weight-bold">Company: {{ \Auth::user()->currentCompany->company->name }} (View Receipt of Payment)</div>
            <div class="card-body">
                <div id="wrapper">
                    <div id="page" class="container">
                        <div class="content">
                            ...
                            <div style="float: right; clear: both;">
                                <div style="display:inline-block;"><button class="btn btn-primary" onclick="location.href = '/received_payments/{{ $receivedPayment->id }}/edit';">Edit</button></div>
