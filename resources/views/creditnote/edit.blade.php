...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header font-weight-bold">Company: {{ \Auth::user()->currentCompany->company->name }} (Edit Credit Note)</div>
            <div class="card-body">
                <div id="wrapper">
                    <div id="page" class="container">
                        <div class="content">
                            ...
                            <form method="POST" action="/creditnote/{{ $creditNote->id }}">
                                ...
                                <input type="hidden" name="credit_note_id" id="credit_note_id" value="{!! $creditNote->id  !!}">
                            ...
                            <script>
                                ...
                                function getAmounts(note_line)
                                {
                                  ...
                                  var credit_note_id = document.getElementById('credit_note_id').value;
                                  ...
                                  $.ajax({
                                    ...
                                    data: {_token: _token, invoice_id: invoice_id, invoice_line_id: invoice_line_id, quantity_returned: quantity_returned, credit_note_id: credit_note_id},
                                    dataType: 'json',
                                    success:function(data) {
                                ...
                                @if (!empty(old('item_lines')))
                                    ...
                                    updateTotal();
                                @else
                                    @if (!empty($creditNote->invoice->itemLines))
                                        @foreach ($creditNote->invoice->itemLines as $line)
